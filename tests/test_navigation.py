...
def test_every_registered_page_key_present_with_no_change_to_labels_or_order():
    ...
    assert [k for k, _ in PRIMARY_NAV] == ["dashboard", "radar_inbox", "themes", "signals", "research"]
...
@pytest.mark.parametrize("harness_file", ["dashboard_page.py", "radar_inbox_page.py", "themes_page.py", "signals_page.py", "research_page.py", "methodology_page.py", "about_page.py", "watchlists_page.py"])
